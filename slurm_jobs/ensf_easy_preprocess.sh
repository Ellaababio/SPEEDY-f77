#!/bin/bash
#SBATCH --job-name=ENSF_PREP_EASY
#SBATCH --output=ENSF_PREP_EASY_%j.out
#SBATCH --error=ENSF_PREP_EASY_%j.err
...
srun python amlcs_pre.py amlcs_pre_t21_ENSF_easy.csv
